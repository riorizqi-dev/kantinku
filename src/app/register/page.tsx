        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full items-center justify-center gap-2 rounded-full bg-kantin-600 py-3.5 text-sm font-bold text-white shadow-soft transition-all duration-300 hover:bg-kantin-700 hover:scale-[1.01] disabled:opacity-60"
            >
          ...
          <p className="mt-5 text-center text-sm text-stone-500">
            ...
            <Link
              href="/login"
              className="font-bold text-kantin-700 hover:underline dark:text-kantin-400"
            >
              Masuk
            </Link>
          </p>
