      ...
      <div className="flex min-h-[100dvh] items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-kantin-600 text-white shadow-soft">
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-stone-200 bg-stone-50 px-3.5 py-3 text-sm font-medium transition focus:border-kantin-500 focus:ring-2 focus:ring-kantin-500/20 dark:border-stone-700 dark:bg-stone-900"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  data-1p-ignore
                  data-form-type="other"
                  className="w-full rounded-xl border border-stone-200 bg-stone-50 px-3.5 py-3 pr-12 text-sm font-medium transition focus:border-kantin-500 focus:ring-2 focus:ring-kantin-500/20 dark:border-stone-700 dark:bg-stone-900"
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full items-center justify-center gap-2 rounded-full bg-kantin-600 py-3.5 text-sm font-bold text-white shadow-soft transition-all duration-300 hover:bg-kantin-700 hover:scale-[1.01] active:scale-[0.99] disabled:opacity-60"
            >
          ...
          <div className="mt-5 space-y-3 text-center text-sm text-stone-500 dark:text-white/45">
            <p>
              ...
              <Link
                href="/register"
                className="font-bold text-kantin-600 hover:underline dark:text-kantin-400"
              >
                Daftar
              </Link>
            </p>
            <button
              ...
              className="font-semibold text-stone-600 transition hover:text-kantin-700 dark:text-stone-300"
            >
              Lanjut sebagai tamu
            </button>
          </div>
