    ...
    <PageTransition>
      <div className="min-h-[100dvh] w-full bg-stone-100 px-4 py-8 dark:bg-[#0a0a0b] sm:px-6 sm:py-10 lg:px-8">
        <div className="mx-auto w-full max-w-5xl">
          <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-kantin-600 dark:text-[#f97316]/80">
            Area Customer
          </p>
          ...
          <Link
            ...
            className="mt-3 inline-block text-xs font-semibold text-kantin-600 hover:underline dark:text-[#fb923c]"
          >
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            <Link
              href="/"
              className={`group flex items-center gap-4 p-5 transition hover:border-kantin-500/40 dark:hover:border-[#f97316]/30 dark:hover:bg-white/[0.05] ${card}`}
            >
              <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-kantin-500/15 text-kantin-600 dark:bg-[#f97316]/15 dark:text-[#fb923c]">
              ...
              <ArrowRight className="h-4 w-4 text-stone-300 transition group-hover:translate-x-0.5 group-hover:text-kantin-600 dark:text-white/30 dark:group-hover:text-[#fb923c]" />
            </Link>
            <Link
              href="/cart"
              className={`group flex items-center gap-4 p-5 transition hover:border-kantin-500/40 dark:hover:border-[#f97316]/30 dark:hover:bg-white/[0.05] ${card}`}
          ...
          <div className="mt-10">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="flex items-center gap-2 text-sm font-semibold text-stone-900 dark:text-white">
                <Receipt
                  className="h-4 w-4 text-kantin-600 dark:text-[#f97316]"
                  strokeWidth={1.5}
                />
                Pesanan terbaru
              </h2>
              <Link
                href="/orders"
                className="text-xs font-medium text-kantin-600 hover:underline dark:text-[#fb923c]"
              >
                Lihat semua
              </Link>
            </div>
                  ...
                  <li key={o.id} className={`${cardSolid} px-4 py-3`}>
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-semibold text-kantin-600 dark:text-[#fb923c]">
