        ...
        <div className="space-y-4 px-5 py-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-stone-200 bg-stone-50 py-2.5 pl-10 pr-3 text-sm font-medium focus:border-[#f97316] focus:ring-2 focus:ring-[#f97316]/20 dark:border-white/10 dark:bg-white/5"
              />
            </div>
          </div>
          ...
          <div>
            <div className="mb-1 flex items-center justify-between">
              ...
              <span className="rounded bg-[#f97316]/10 px-1.5 py-0.5 text-xs font-bold text-[#f97316]">
                {marginN}%
              </span>
            </div>
            <input
          ...
          {suggested > 0 && (
            <div className="rounded-xl border border-[#f97316]/30 bg-gradient-to-br from-[#f97316]/10 to-transparent p-4 text-center">
              <p className="text-[11px] font-medium uppercase tracking-wide text-stone-500 dark:text-white/40">
                Harga jual disarankan
              </p>
              <p className="mt-1 text-3xl font-extrabold tabular-nums text-[#f97316]">
                {fmtMoney(suggested)}
              </p>
          ...
          <div className="rounded-lg border border-stone-200 bg-stone-50 p-3 text-[11px] leading-relaxed text-stone-500 dark:border-white/[0.07] dark:bg-white/[0.04] dark:text-white/45">
            <p className="mb-1 flex items-center gap-1 font-semibold">
              <Sparkles className="h-3 w-3 text-[#f97316]" strokeWidth={1.75} />
              Cara baca
            </p>
          ...
          <div className="flex items-center gap-2 pb-2">
            <button
              ...
              className="inline-flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-lg bg-[#f97316] py-2.5 text-sm font-semibold text-white transition hover:bg-[#ea580c] disabled:cursor-not-allowed disabled:opacity-40"
            >
