        ...
        >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 pb-4 pt-4">
              ...
              {/* Harga */}
              <p
                className="mt-4 flex min-w-0 flex-wrap items-baseline gap-x-1 tabular-nums text-[#059669]"
                aria-label={formatRupiah(displayPrice)}
              >
                <span className="shrink-0 text-sm font-medium tracking-[0.02em] text-[#059669]/75">
                  Rp
                </span>
            ...
            <div className="sticky bottom-0 z-10 border-t border-stone-100 bg-white/95 p-4 backdrop-blur dark:border-white/[0.06] dark:bg-[#121214]/95">
              <div className="mb-3 flex items-baseline justify-between gap-2">
                ...
                <span
                  className="text-lg font-semibold tabular-nums text-[#059669]"
