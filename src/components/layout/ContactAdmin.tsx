...
export function ContactAdmin({
  ...
  if (variant === "icon") {
    return (
      <a
        ...
        title="Hubungi Admin"
        className={cn(
          "inline-flex h-9 w-9 cursor-pointer items-center justify-center rounded-full text-[#059669] transition-colors hover:bg-amber-50 dark:text-amber-400 dark:hover:bg-white/[0.06]",
          className
        )}
      >
  ...
  if (variant === "pill") {
    return (
      <a
        ...
        rel="noopener noreferrer"
        className={cn(
          "inline-flex min-h-[40px] cursor-pointer items-center justify-center gap-2 rounded-full bg-[#059669] px-5 py-2 text-sm font-bold text-white transition hover:bg-[#047857]",
          className
        )}
      >
  ...
  return (
    <a
      ...
      rel="noopener noreferrer"
      className={cn(
        "inline-flex cursor-pointer items-center gap-1.5 text-xs font-semibold text-stone-400 transition-colors hover:text-[#059669] dark:text-white/30 dark:hover:text-amber-400",
        className
      )}
    >
